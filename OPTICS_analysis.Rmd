...
#Now we want to extract the clustering for DBSCAN with a matching epsilon value determined by knndist and the kneedle algorithm. Sensitivity parameter was chosen by trying out a few values und looking at sample knndistgraphs.
