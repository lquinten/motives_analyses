...
#We use cross validation to find the optimal number of clusters in lpa. We form a grid of 3 to 7 clusters which are the cluster numbers we expect thepretically. The models are added to a tibble - the lpa models object.
lpa_models <- list()
G <- 3:7
...
#We compute the silhouette index on our cross validation sets. The 
