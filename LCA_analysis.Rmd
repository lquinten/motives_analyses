...
<!-- Modus refers here to how many participants share this modal value. mode_value gives the actual modal value. v is a measure of variability for categorical variables and refers to the probability that two randomly drawn participants belong to different categories. -->
