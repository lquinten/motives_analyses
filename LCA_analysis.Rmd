...
lr_2 = lapply(BCH_results$models, logistftest, test=2, weights=BCH_expanded_dataframe$modal_weight_2),
lr_3 = lapply(BCH_results$models, logistftest, test=3, weights=BCH_expanded_dataframe$modal_weight_2),
lr_1_0.01 = lapply(BCH_results$models_0.01_weights, logistftest, test=1, weights=BCH_expanded_dataframe$modal_weight_2),
lr_2_0.02 = lapply(BCH_results$models_0.01_weights, logistftest, test=2, weights=BCH_expanded_dataframe$modal_weight_2),
lr_3_0.03 = lapply(BCH_results$models_0.01_weights, logistftest, test=3, weights=BCH_expanded_dataframe$modal_weight_2))
