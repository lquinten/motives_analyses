...
# Data
data_males <- haven::read_spss("./total sample's analysis/data/dataE_clear5 2209.sav") %>% 
...
# Data
data_females <- haven::read_spss("./total sample's analysis/data/dataE_clear5 2209.sav") %>% 
  select(gender, CASE, sexdrive2, CSBD, PPCS_6, meffort, socialanx, lon, mvalue, attr) %>% 
  filter(gender == 1) %>% 
  select(-gender)
